            ...
            <div class="container-fluid">
                ...
                <div class="white-box"> 
                    ...
                    <ul class="nav customtab nav-tabs" role="tablist">
						<li role="presentation" class="active"><a href="file:///C:/Users/VIIPL02/Downloads/18-4-18/dashboard/myprofile.html#personaldata" aria-controls="personaldata" role="tab" data-toggle="tab" aria-expanded="true"><span class=""><i class="ti-user"></i></span><span class=""> Billing Updation</span></a></li>
						
						<li role="presentation" class=""><a href="file:///C:/Users/VIIPL02/Downloads/18-4-18/dashboard/myprofile.html#contactdata" aria-controls="contactdata" role="tab" data-toggle="tab" aria-expanded="false"><span class=""><i class="ti-location-pin"></i></span> <span class="">Meter Reader Wise Billing Updation</span></a></li>
						
<!-- 						<li role="presentation"><a href="file:///C:/Users/VIIPL02/Downloads/18-4-18/dashboard/myprofile.html#legitimationdata" aria-controls="legitimationdata" role="tab" data-toggle="tab" aria-expanded="false"><span class=""><i class="ti-files"></i></span> <span class="">Salary Reports</span></a></li>
 -->						
					...
					<div class="tab-content">
						...
						<div class="form-material form-horizontal">
							...
							<div class="form-group">
                                        <label class="col-sm-12" for="cob">Division Name</label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12" for="blling"><b>To Day Billing</b></label>
                                        <div class="col-md-12">
                                            <input type="text" id="blling" name="blling" class="form-control" >
                                        </div>
                                    </div>
							...
							<br><br><br><br>
								<br><br><br><br><br>
							<h4>Toatal Consumers:<b> 60000</b></h4>
							<h4>Billable Consumers: <b>50000</b></h4>
							<h4>Billed Consumers: <b>20000</b></h4>
							<h4>Remaining Consumers: <b>30000</b></h4>
							<h4>Billing Percentage: <b>40%</b></h4>
						...
						<!-- --------------------------------------------------------------------------------- -->
						 <div role="tabpanel" class="tab-pane fade" id="contactdata">
							...
							<div class="form-group">
                                        <label class="col-md-12" for="surname">Meter Reader Wise Billing Upload Formatt</label>
                                      
						 <button type="submit" class="btn btn-info waves-effect waves-light m-r-10">Download</button>                                    
							
                            </div>
							
							
							  <div class="form-group">
                                        <label class="col-md-12" for="salarycreditedfile">Meter Reader Wise Billing Upload</label>
                                         <div class="col-md-12">
                                            <input type="file" id="salarycreditedfile" name="salarycreditedfile">
						...
						<!-- <div role="tabpanel" class="tab-pane fade" id="addressdata">
							<form class="form-material form-horizontal">
								<div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-12" for="streeta">Street Address</label>
                                        <div class="col-md-12">
                                            <input type="text" id="streeta" name="streeta" class="form-control" placeholder="Schroeterstr">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12" for="addition"></label>
                                        <div class="col-md-12">
                                            <input type="date" id="addition" name="addition" class="form-control" placeholder="Addition">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12" for="city">City</label>
                                        <div class="col-md-12">
                                            <input type="text" id="city" name="city" class="form-control" placeholder="Dresden">
                                        </div>
                                    </div>
									<div class="form-group">
                                        <label class="col-md-12" for="federals">Federal State</label>
                                        <div class="col-md-12">
								...
								<div class="col-md-5 pull-right">								
                                    <div class="form-group">
                                        <label class="col-md-12" for="housen">House Number</label>
                                        <div class="col-md-12">
                                            <input type="text" id="housen" name="housen" class="form-control" placeholder="Only Numbers are Allowed">
                                        </div>
                                    </div>
									<div class="form-group">
                                        <label class="col-md-12" for="addition"></label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12" for="avf">Address Valid From</label>
                                        <div class="col-md-12">
                                            <input type="date" id="avf" name="avf" class="form-control" placeholder="Enter Date DD MM YYYY">
                                        </div>
                                    </div>                                    
