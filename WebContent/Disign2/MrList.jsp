...
<head>
  ...
  #progress_bar .percent {
	...
	<body class="no-skin" onload="TableSort();">
...
{  
 ...
 var url="MrList_code.jsp?number="+number; 
...
document.getElementById('data2').innerHTML=val;  
		    ...
		    <input type="text" id="myInput" onkeyup="TableSort()" placeholder="Search for names.." title="Type in a name">
			</form>	
