...
<form class="form-material form-horizontal" name="dataview" id="dataview" action="/CspdclDashBoard/ExcelDownalod" method="get">
...
<input type="date" id="to" name="to" class="form-control">
  ...
  <button type="submit" class="btn btn-success waves-effect waves-light m-r-10" >Download</button>                                    

 </form>     
 
 <!-- <form action="/CspdclDashBoard/ExcelDownalod" method="get"> -->
<!--   <button type="submit" class="btn btn-success waves-effect waves-light m-r-10" >Download</button>                                    
 -->        <!-- </form> -->
