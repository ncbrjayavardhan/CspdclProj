...
<label class="col-sm-12" for="cob">Discome</label>
     ...
     <div class="form-group">
         ...
         <div class="col-sm-12">
             <select class="form-control" id="mru" name="mru"  required="required">
...
<div class="col-md-12">
<input type="date" id="from" name="from" class="form-control" required="required">
</div>
</div>
</div>
...
<div class="form-group">
          ...
          <div class="col-sm-12">
              <select class="form-control" id="circle" name="circle" onchange="GetMru()" required="required">
