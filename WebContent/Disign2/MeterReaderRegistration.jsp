...
/* var url="TotalUploadedData.jsp";  */ 
 ...
 /* var url="MeterReaderRegistration_code.jsp?mrname="+mrname; */
  ...
  var url="MeterReaderRegistration_code.jsp?mrname="+mrname+"&address="+address+"&userid="+userid+"&email="+email+"&desigantion="+desigantion+"&imei2="+imei2+"&groups="+groups+"&fname="+fname+"&proof="+proof+"&password="+password+"&mobile="+mobile+"&imei1="+imei1+"&superid="+superid+"&division="+division;
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12" for="passportn">Superviser Id</label>
                                         <select class="form-control" id="superid" name="superid">
                                                <option value="<%=session.getAttribute("userid") %>"><%=session.getAttribute("username") %></option>
                                            </select>
                                    </div>
