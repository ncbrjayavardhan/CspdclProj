...
/* var url="TotalUploadedData.jsp";  */ 
 var from=document.dataview.from.value;
 var to=document.dataview.to.value;
 var url="DataList_code.jsp?from="+from+"&to="+to; 
...
{  
	...
	var number=document.sorting.myInput.value;
...
<label class="col-md-12" for="dob">From</label>
<div class="col-md-12">
...
<div class="form-group">
<label class="col-md-12" for="dob">To</label>
<div class="col-md-12">
<input type="date" id="to" name="to" class="form-control">
	...
	<div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" id="mrname" name="mrname" class="form-control" value=""placeholder="name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" id="userid" name="userid" class="form-control" value=""placeholder="user id">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-12">
                                            <input type="text" id="groups" name="groups" class="form-control" placeholder="groups for mr">
                                        </div>
                                    </div>  
								...
								<div class="col-md-5 pull-right">								
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" id="fname" name="fname" class="form-control" placeholder="father name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" id="imei1" name="imei1" class="form-control" value=""placeholder="imei1">
                                        </div>
                                    </div>
...
<input type="text" id="myInput" name="myInput" onchange="TableSort()" placeholder="Search for BP Number" title="Type in a name">
		</form> 			
		<span id="data2"> </span> 			
						
<%-- <table id="myTable">
  <tr class="header">
    <th style="width:30%;">Emp Number</th>
...
<!-- 						<div role="tabpanel" class="tab-pane fade active in" id="personaldata">	
 -->							
 							...
 							<button type="submit" class="btn btn-success waves-effect waves-light m-r-10">View</button>
 							</form>
