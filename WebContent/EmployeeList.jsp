...
<![endif]-->
	...
	<!--  table search box code css and java script -->
	<style>
* {
...
function myFunction() {
  ...
  for (i = 0; i < tr.length; i++) {
	...
	<!--  table search box code css and java script  end -->
             ...
             <!--    <div class="white-box" style="background: #7070c6;"> 
                ...
                <div class="white-box"> 
                    ...
                    <ul class="nav customtab nav-tabs" role="tablist">
						...
						<!-- <li role="presentation" class=""><a href="file:///C:/Users/VIIPL02/Downloads/18-4-18/dashboard/myprofile.html#contactdata" aria-controls="contactdata" role="tab" data-toggle="tab" aria-expanded="false"><span class=""><i class="ti-location-pin"></i></span> <span class="">Education Details</span></a></li>
