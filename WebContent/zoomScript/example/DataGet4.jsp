<%@page import="com.database.DataGettingPojo, com.vaibhu.image.ImageGetting,com.database.DbConnection,com.vaibhu.image.ImageResizer"%>
...
//caheck the metred or not
  ...
  boolean status=db2.status("select * from sbmtopc_android where BILL_BASE!='16' and scno='"+scno+"' and book='"+book+"'");
  
  String Rdg_ImgPath=null;
  String Md_ImgPath=null;  
  if(status==true){
	  
	  	ig.FileStoreInBlob(scno, book, filepath, "rdg", rowno);
	  	ig.FileStoreInBlob(scno, book, filepath, "md", rowno);
  ...
  String val_img=  im.resize(filepath+"/BlurImg2.JPG", filepath+"/BlurImg2_big.JPG", 1024, 786);
